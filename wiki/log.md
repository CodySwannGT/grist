...
| 2026-06-27 | UPDATE | decisions/, architecture/, production/ | Resolved T4 (local-storage mechanism): decision 0008 = IndexedDB via `idb` (not SQLite — bundle/iOS/no-SQL-need); propagated through technical-requirements, engineering-spec, game-tech-design, platform-and-target. |
