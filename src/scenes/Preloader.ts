 ...
 * the Region scene when it carries `?scene=region`, the Ch.1 Opening scene when it
 * carries `?scene=opening` (case-insensitive, with the `?start=<Scene>` alias), else
 * the default Battle.
