 ...
 * current / visited / unvisited relative to where Wren is now. Pure derivation
 * from the field state — the scene renders this and holds no map geometry of its
 * own beyond placement constants.
